  ...
  return (
    <div className="overflow-x-hidden">
      <SEO
        ...
        description="Discover handcrafted luxury furniture and home decor at Maison Luxe Pakistan. Curated collections of premium furniture, lighting, textiles, and accessories to transform your living spaces into sanctuaries of elegance."
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "WebSite",
          name: "Maison Luxe",
          url: "https://maisonluxe.pk",
          description: "Premium home decor and luxury furniture in Pakistan.",
          potentialAction: {
            "@type": "SearchAction",
            target: "https://maisonluxe.pk/search?q={search_term_string}",
      ...
      {/* Flash Sale Banner */}
      <section className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <FlashSaleBanner
          endDate={new Date(Date.now() + 2 * 86400000 + 3600000).toISOString()}
          title="Flash Sale — Up to 40% Off"
          description="Select marble tables, lighting, and decor pieces. While stock lasts."
        />
      </section>
