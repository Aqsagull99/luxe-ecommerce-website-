...
import {
  ...
  ZoomIn, Minus, Plus, Truck, RotateCcw, RotateCw, Shield, Share2, Check
} from 'lucide-react'
      ...
      {product && (
        <SEO
          ...
          jsonLd={{
            ...
            sku: product.sku,
            brand: { "@type": "Brand", name: "Maison Luxe" },
            offers: {
              "@type": "Offer",
                ...
                >
                  ...
                  {images.length >= 3 && (
                    <button
                      ...
                      className={cn(
                        'aspect-square overflow-hidden rounded-sm border-2 transition-all flex items-center justify-center text-[10px] font-medium',
                        show360View ? 'border-primary bg-primary/10 text-primary' : 'border-border hover:border-muted-foreground text-muted-foreground'
                      )}
                      title="Toggle 360° view"
                    >
                      <RotateCw className="size-4 mb-1" />
                      360°
                    </button>
                  )}
            </div>
            ...
            <div className="flex-1">
              {show360View ? (
                ...
                >
                  ...
                  <button className="absolute top-3 right-3 size-8 flex items-center justify-center bg-background/80 rounded-full hover:bg-background transition-colors" aria-label="Zoom in">
